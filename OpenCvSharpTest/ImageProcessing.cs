...
namespace OpenCvSharpTest
{
    ...
    {
        public static Mat LoadImage(string filePath) => Cv2.ImRead(filePath, ImreadModes.AnyColor);
        ...
        public static Mat ChangeGamma(this Mat src, double gamma)
        {
            ...
            lookUpTable.SetArray(lookUpTableData);
        ...
        public static Mat DrawContour(this Mat image, IEnumerable<Point> countour)
        {
            ...
            image.DrawContours(new List<IEnumerable<Point>> { countour }, -1, Scalar.Red, 100);
            return image;
        }
